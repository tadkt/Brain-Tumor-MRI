...
def main():
    ...
    trainset = torchvision.datasets.ImageFolder(root=r'G:\My Drive\B3 Year Data Science (Gen 12)\Project Brain Cancer\Project-Brain-Tumor-MRI\data\Testing', transform=transform_train)
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=128, shuffle=True, num_workers=2)
    testset = torchvision.datasets.ImageFolder(root=r'G:\My Drive\B3 Year Data Science (Gen 12)\Project Brain Cancer\Project-Brain-Tumor-MRI\data\Training', transform=transform_train)
